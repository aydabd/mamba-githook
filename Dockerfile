...
# docker build -t mamba-githook:latest -f Dockerfile .
#
# To run the integration tests, run the following command from the root of the repository:
# docker run --rm -it mamba-githook:latest
#
# To run the integration tests and print the output of the tests, run the following command from the root of the repository:
# docker run --rm -it mamba-githook:latest | tee output.txt
######################################################################################################################################
